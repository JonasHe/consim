 ...
 */
class Traveling extends Travel
{
	/**
	 ...
	 *
	 * @param int $route_id travel action id
	 * @param int $start_location_id
	 * @return TravelLocation $this object for chaining calls; load()->set()->save()
	 * @access public
	 * @throws \consim\core\exception\out_of_bounds
	 */
	public function load($route_id, $start_location_id)
	{
		$sql = 'SELECT l1.id AS startId, l1.name AS startName, l1.description AS startDescription, l1.image AS startImage,
			...
			FROM ' . $this->consim_route_table . ' a
